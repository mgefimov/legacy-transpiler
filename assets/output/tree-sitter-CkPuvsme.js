(async function () {
  ...
  var LookaheadIterator = class {
    ...
    resetState(e) {
      return Boolean(C._ts_lookahead_iterator_reset_state(this[0], e));
    }
    [Symbol.iterator]() {
      return {
  ...
  function marshalEdit(e, t = TRANSFER_BUFFER) {
    (marshalPoint(t, e.startPosition), marshalPoint(t += SIZE_OF_POINT, e.oldEndPosition), marshalPoint(t += SIZE_OF_POINT, e.newEndPosition), t += SIZE_OF_POINT, C.setValue(t, e.startIndex, "i32"), t += SIZE_OF_INT, C.setValue(t, e.oldEndIndex, "i32"), t += SIZE_OF_INT, C.setValue(t, e.newEndIndex, "i32"), t += SIZE_OF_INT);
  }
  ...
  var LANGUAGE_FUNCTION_REGEX = /^tree_sitter_\w+$/, Language = class e {
    ...
    get metadata() {
      ...
      return 0 === C.getValue(TRANSFER_BUFFER, "i32") ? null : unmarshalLanguageMetadata(TRANSFER_BUFFER + SIZE_OF_INT);
    }
    get fieldCount() {
    ...
    static async load(t) {
      ...
      if (t instanceof Uint8Array) r = t; else if (globalThis.process?.versions.node) {
        const e = await __vitePreload(() => window.LegacyTranspiler._moduleExports["https://assets-proxy.anthropic.com/claude-ai/v2/assets/v1/index-BIdSPwg7.js"].then(e => e.wg), __vite__mapDeps([0, 1, 2]), "https://assets-proxy.anthropic.com/claude-ai/v2/assets/v1/tree-sitter-CkPuvsme.js");
  ...
  async function Module2(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      const {createRequire: e} = await __vitePreload(async () => {
        const {createRequire: e} = await window.LegacyTranspiler._moduleExports["https://assets-proxy.anthropic.com/claude-ai/v2/assets/v1/index-BIdSPwg7.js"].then(e => e.wk);
        return {
          createRequire: e
        };
    ...
    if ((__name(locateFile, "locateFile"), ENVIRONMENT_IS_NODE)) {
      var fs = require("fs");
      (_scriptName.startsWith("file:") && (scriptDirectory = require("path").dirname(require("url").fileURLToPath(_scriptName)) + "/"), readBinary = __name(e => (e = isFileURI(e) ? new URL(e) : e, fs.readFileSync(e)), "readBinary"), readAsync = __name(async (e, t = !0) => (e = isFileURI(e) ? new URL(e) : e, fs.readFileSync(e, t ? void 0 : "utf8")), "readAsync"), process.argv.length > 1 && (thisProgram = process.argv[1].replace(/\\/g, "/")), arguments_ = process.argv.slice(2), quit_ = __name((e, t) => {
      ...
      (ENVIRONMENT_IS_WORKER && (readBinary = __name(e => {
        ...
        if (isFileURI(e)) return new Promise((t, r) => {
          var s = new XMLHttpRequest();
          (s.open("GET", e, !0), s.responseType = "arraybuffer", s.onload = () => {
            200 == s.status || 0 == s.status && s.response ? t(s.response) : r(s.status);
    ...
    var out = console.log.bind(console), err = console.error.bind(console), dynamicLibraries = [], wasmBinary, ABORT = !1, EXITSTATUS;
    function assert(e, t) {
      e || abort(t);
    }
    __name(assert, "assert");
    var isFileURI = __name(e => e.startsWith("file://"), "isFileURI"), readyPromiseResolve, readyPromiseReject, wasmMemory, HEAP8, HEAPU8, HEAPU16, HEAPU32, HEAP_DATA_VIEW, runtimeInitialized = !1;
    ...
    (__name(updateMemoryViews, "updateMemoryViews"), __name(initMemory, "initMemory"));
    var __RELOC_FUNCS__ = [];
    function preRun() {
    ...
    (__name(preRun, "preRun"), __name(initRuntime, "initRuntime"), __name(preMain, "preMain"), __name(postRun, "postRun"));
    var runDependencies = 0, dependenciesFulfilled = null, wasmBinaryFile;
    ...
    function abort(e) {
      (Module.onAbort?.(e), err(e = "Aborted(" + e + ")"), ABORT = !0, e += ". Build with -sASSERTIONS for more info.");
    ...
    async function createWasm() {
      function e(e, t) {
        ...
        return (r.neededDynlibs && (dynamicLibraries = r.neededDynlibs.concat(dynamicLibraries)), mergeLibSymbols(wasmExports, "main"), LDSO.init(), loadDylibs(), __RELOC_FUNCS__.push(wasmExports.__wasm_apply_data_relocs), assignWasmExports(wasmExports), removeRunDependency(), wasmExports);
      }
      function t(t) {
        return e(t.instance, t.module);
      }
      (__name(e, "receiveInstance"), addRunDependency(), __name(t, "receiveInstantiationResult"));
      var r = getWasmImports();
      return Module.instantiateWasm ? new Promise((t, s) => {
        Module.instantiateWasm(r, (r, s) => {
          t(e(r, s));
        });
      }) : (wasmBinaryFile ??= findWasmBinary(), t(await instantiateAsync(wasmBinary, wasmBinaryFile, r)));
    }
    ...
    var GOT = {}, currentModuleWeakSymbols = new Set([]), GOTHandler = {
    ...
    }, LE_HEAP_LOAD_F32 = __name(e => HEAP_DATA_VIEW.getFloat32(e, !0), "LE_HEAP_LOAD_F32"), LE_HEAP_LOAD_F64 = __name(e => HEAP_DATA_VIEW.getFloat64(e, !0), "LE_HEAP_LOAD_F64"), LE_HEAP_LOAD_I16 = __name(e => HEAP_DATA_VIEW.getInt16(e, !0), "LE_HEAP_LOAD_I16"), LE_HEAP_LOAD_I32 = __name(e => HEAP_DATA_VIEW.getInt32(e, !0), "LE_HEAP_LOAD_I32"), LE_HEAP_LOAD_U32 = __name(e => HEAP_DATA_VIEW.getUint32(e, !0), "LE_HEAP_LOAD_U32"), LE_HEAP_STORE_F32 = __name((e, t) => HEAP_DATA_VIEW.setFloat32(e, t, !0), "LE_HEAP_STORE_F32"), LE_HEAP_STORE_F64 = __name((e, t) => HEAP_DATA_VIEW.setFloat64(e, t, !0), "LE_HEAP_STORE_F64"), LE_HEAP_STORE_I16 = __name((e, t) => HEAP_DATA_VIEW.setInt16(e, t, !0), "LE_HEAP_STORE_I16"), LE_HEAP_STORE_I32 = __name((e, t) => HEAP_DATA_VIEW.setInt32(e, t, !0), "LE_HEAP_STORE_I32"), LE_HEAP_STORE_U32 = __name((e, t) => HEAP_DATA_VIEW.setUint32(e, t, !0), "LE_HEAP_STORE_U32"), callRuntimeCallbacks = __name(e => {
      for (; e.length > 0; ) e.shift()(Module);
    }, "callRuntimeCallbacks"), onPostRuns = [], addOnPostRun = __name(e => onPostRuns.push(e), "addOnPostRun"), onPreRuns = [], addOnPreRun = __name(e => onPreRuns.push(e), "addOnPreRun"), UTF8Decoder = "undefined" != typeof TextDecoder ? new TextDecoder() : void 0, findStringEnd = __name((e, t, r, s) => {
      var a = t + r;
      if (s) return a;
      for (; e[t] && !(t >= a); ) ++t;
      return t;
    }, "findStringEnd"), UTF8ArrayToString = __name((e, t = 0, r, s) => {
      var a = findStringEnd(e, t, r, s);
      ...
      for (var _ = ""; t < a; ) {
        ...
        if (128 & n) {
          ...
          if (192 != (224 & n)) {
            var i = 63 & e[t++];
            if ((n = 224 == (240 & n) ? (15 & n) << 12 | o << 6 | i : (7 & n) << 18 | o << 12 | i << 6 | 63 & e[t++]) < 65536) _ += String.fromCharCode(n); else {
              var l = n - 65536;
              _ += String.fromCharCode(55296 | l >> 10, 56320 | 1023 & l);
            }
          } else _ += String.fromCharCode((31 & n) << 6 | o);
        } else _ += String.fromCharCode(n);
      }
      return _;
      ...
      function a() {
        for (var r = 0, s = 1; ; ) {
          var a = e[t++];
          if ((r += (127 & a) * s, s *= 128, !(128 & a))) break;
        }
        return r;
      }
      function _() {
      ...
      function n() {
        for (var e = a(), t = []; e--; ) t.push(_());
        return t;
      }
      function o(e, t) {
        if (e) throw new Error(t);
      }
      if ((__name(s, "getU8"), __name(a, "getLEB"), __name(_, "getString"), __name(n, "getStringList"), __name(o, "failIf"), e instanceof WebAssembly.Module)) {
        var i = WebAssembly.Module.customSections(e, "dylink.0");
        (o(0 === i.length, "need dylink section"), r = (e = new Uint8Array(i[0])).length);
      } else {
        var l = new Uint32Array(new Uint8Array(e.subarray(0, 24)).buffer);
        (o(!(1836278016 == l[0] || 6386541 == l[0]), "need to see wasm magic number"), o(0 !== e[8], "need the dylink section to be first"), t = 9);
        var u = a();
        (r = t + u, o("dylink.0" !== _()));
      }
      for (var d = {
        ...
        var m = s(), c = a();
        if (1 === m) (d.memorySize = a(), d.memoryAlign = a(), d.tableSize = a(), d.tableAlign = a()); else if (2 === m) d.neededDynlibs = n(); else if (3 === m) for (var h = a(); h--; ) {
          var g = _();
          256 & a() && d.tlsExports.add(g);
        } else if (4 === m) for (h = a(); h--; ) {
          _();
          g = _();
          1 == (3 & a()) && d.weakImports.add(g);
        } else 5 === m ? d.runtimePaths = n() : t += c;
      }
      return d;
    }, "getDylinkMetadata");
    function getValue(e, t = "i8") {
      switch ((t.endsWith("*") && (t = "*"), t)) {
        ...
        case "i8":
          return HEAP8[e];
        case "i16":
          return LE_HEAP_LOAD_I16(2 * (e >> 1));
        case "i32":
          return LE_HEAP_LOAD_I32(4 * (e >> 2));
        case "i64":
          return LE_HEAP_LOAD_I64(8 * (e >> 3));
        case "float":
          return LE_HEAP_LOAD_F32(4 * (e >> 2));
        case "double":
          return LE_HEAP_LOAD_F64(8 * (e >> 3));
        case "*":
          return LE_HEAP_LOAD_U32(4 * (e >> 2));
        default:
    ...
    var newDSO = __name((e, t, r) => {
      ...
      d: 124,
      e: 111
    }, generateTypePack = __name(e => uleb128EncodeWithLen(Array.from(e, e => wasmTypeCodes[e])), "generateTypePack"), convertJsFunctionToWasm = __name((e, t) => {
      var r = Uint8Array.of(0, 97, 115, 109, 1, 0, 0, 0, 1, ...uleb128EncodeWithLen([1, 96, ...generateTypePack(t.slice(1)), ...generateTypePack("v" === t[0] ? "" : t[0])]), 2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0), s = new WebAssembly.Module(r);
      ...
      for (var a in e) {
        var _ = e[a];
        ("object" == typeof _ && (_ = _.value), "number" == typeof _ && (_ += t), s[a] = _);
      }
      return (updateGOT(s, r), s);
    }, "relocateExports"), isSymbolDefined = __name(e => {
      var t = wasmImports[e];
      return !(!t || t.stub);
    }, "isSymbolDefined"), dynCall = __name((e, t, r = [], s = !1) => {
      var a = getWasmTableEntry(t)(...r);
      function _(e) {
        return e;
      }
      return (__name(_, "convert"), a);
      ...
      try {
        ...
        if ((stackRestore(s), a !== a + 0)) throw a;
        if ((_setThrew(1, 0), "j" == e[0])) return 0n;
      }
    }, "createInvokeFunction"), resolveGlobalSymbol = __name((e, t = !1) => {
      var r;
      ...
      function loadModule() {
        var memAlign = Math.pow(2, metadata.memoryAlign), memoryBase = metadata.memorySize ? alignMemory(getMemory(metadata.memorySize + memAlign), memAlign) : 0, tableBase = metadata.tableSize ? wasmTable.length : 0, moduleExports;
        function resolveSymbol(e) {
          var t = resolveGlobalSymbol(e).sym;
          return (!t && localScope && (t = localScope[e]), t || (t = moduleExports[e]), t);
        }
        (handle && (HEAP8[handle + 8] = 1, LE_HEAP_STORE_U32(4 * (handle + 12 >> 2), memoryBase), LE_HEAP_STORE_I32(4 * (handle + 16 >> 2), metadata.memorySize), LE_HEAP_STORE_U32(4 * (handle + 20 >> 2), tableBase), LE_HEAP_STORE_I32(4 * (handle + 24 >> 2), metadata.tableSize)), metadata.tableSize && wasmTable.grow(metadata.tableSize), __name(resolveSymbol, "resolveSymbol"));
        var proxyHandler = {
          get(e, t) {
            switch (t) {
              case "__memory_base":
        ...
        function postInstantiation(module, instance) {
          ...
          if ((updateTableMap(tableBase, metadata.tableSize), moduleExports = relocateExports(instance.exports, memoryBase), flags.allowUndefined || reportUndefinedSymbols(), __name(addEmAsm, "addEmAsm"), ("__start_em_asm" in moduleExports))) for (var start = moduleExports.__start_em_asm, stop = moduleExports.__stop_em_asm; start < stop; ) {
      ...
      return (currentModuleWeakSymbols = metadata.weakImports, __name(loadModule, "loadModule"), flags = {
        ...flags,
        rpath: {
    ...
    function loadDynamicLibrary(e, t = {
      ...
      if (a) return (t.global ? a.global || (a.global = !0, mergeLibSymbols(a.exports, e)) : r && Object.assign(r, a.exports), t.nodelete && a.refcount !== 1 / 0 && (a.refcount = 1 / 0), a.refcount++, s && (LDSO.loadedLibsByHandle[s] = a), !t.loadAsync || Promise.resolve(!0));
      function _() {
        if (s) {
          var r = LE_HEAP_LOAD_U32(4 * (s + 28 >> 2)), a = LE_HEAP_LOAD_U32(4 * (s + 32 >> 2));
          if (r && a) {
            var _ = HEAP8.slice(r, r + a);
            return t.loadAsync ? Promise.resolve(_) : _;
          }
        }
        var n = locateFile(e);
        if (t.loadAsync) return asyncLoad(n);
        if (!readBinary) throw new Error(`${n}: file not found, and synchronous loading of external files is not available`);
        return readBinary(n);
      }
      function n() {
        return t.loadAsync ? _().then(a => loadWebAssemblyModule(a, t, e, r, s)) : loadWebAssemblyModule(_(), t, e, r, s);
      }
      function o(t) {
        (a.global ? mergeLibSymbols(t, e) : r && Object.assign(r, t), a.exports = t);
      }
      return ((a = newDSO(e, s, "loading")).refcount = t.nodelete ? 1 / 0 : 1, a.global = t.global, __name(_, "loadLibData"), __name(n, "getExports"), __name(o, "moduleLoaded"), t.loadAsync ? n().then(e => (o(e), !0)) : (o(n()), !0));
    }
    ...
    var reportUndefinedSymbols = __name(() => {
      for (var [e, t] of Object.entries(GOT)) if (0 == t.value) {
        ...
        if ("function" == typeof r) t.value = addFunction(r, r.sig); else {
          if ("number" != typeof r) throw new Error(`bad export type for '${e}': ${typeof r}`);
          t.value = r;
        }
      }
    }, "reportUndefinedSymbols"), loadDylibs = __name(() => {
      dynamicLibraries.length ? (addRunDependency(), dynamicLibraries.reduce((e, t) => e.then(() => loadDynamicLibrary(t, {
        loadAsync: !0,
        global: !0,
        nodelete: !0,
        allowUndefined: !0
    ...
    function setValue(e, t, r = "i8") {
      switch ((r.endsWith("*") && (r = "*"), r)) {
        ...
        case "i32":
          ...
          break;
        case "i64":
          LE_HEAP_STORE_I64(8 * (e >> 3), BigInt(t));
          break;
        case "float":
    ...
    var getHeapMax = __name(() => 2147483648, "getHeapMax"), growMemory = __name(e => {
      ...
      for (var s = 1; s <= 4; s *= 2) {
        ...
        var _ = Math.min(r, alignMemory(Math.max(e, a), 65536));
        if (growMemory(_)) return !0;
      }
      return !1;
    ...
    function _fd_seek(e, t, r, s) {
      return (t = bigintToI53Checked(t), 70);
    }
    (__name(_fd_seek, "_fd_seek"), _fd_seek.sig = "iijip");
    var printCharBuffers = [null, [], []], printChar = __name((e, t) => {
      var r = printCharBuffers[e];
      0 === t || 10 === t ? ((1 === e ? out : err)(UTF8ArrayToString(r)), r.length = 0) : r.push(t);
    }, "printChar"), _fd_write = __name((e, t, r, s) => {
      for (var a = 0, _ = 0; _ < r; _++) {
        var n = LE_HEAP_LOAD_U32(4 * (t >> 2)), o = LE_HEAP_LOAD_U32(4 * (t + 4 >> 2));
        t += 8;
        for (var i = 0; i < o; i++) printChar(e, HEAPU8[n + i]);
        a += o;
      }
      return (LE_HEAP_STORE_U32(4 * (s >> 2), a), 0);
    }, "_fd_write");
    ...
    function _tree_sitter_parse_callback(e, t, r, s, a) {
      ...
      "string" == typeof _ ? (setValue(a, _.length, "i32"), stringToUTF16(_, e, 10240)) : setValue(a, 0, "i32");
    }
    ...
    (_fd_write.sig = "iippp", __name(_tree_sitter_log_callback, "_tree_sitter_log_callback"), __name(_tree_sitter_parse_callback, "_tree_sitter_parse_callback"), __name(_tree_sitter_progress_callback, "_tree_sitter_progress_callback"), __name(_tree_sitter_query_progress_callback, "_tree_sitter_query_progress_callback"));
    ...
    var exitJS = __name((e, t) => {
      ...
      return t;
    }, "lengthBytesUTF8"), stringToUTF8Array = __name((e, t, r, s) => {
      if (!(s > 0)) return 0;
      for (var a = r, _ = r + s - 1, n = 0; n < e.length; ++n) {
    ...
    function callMain(e = []) {
      ...
      if (t) {
        ...
        var r = e.length, s = stackAlloc(4 * (r + 1)), a = s;
        (e.forEach(e => {
          (LE_HEAP_STORE_U32(4 * (a >> 2), stringToUTF8OnStack(e)), a += 4);
        }), LE_HEAP_STORE_U32(4 * (a >> 2), 0));
        try {
          var _ = t(r, s);
          return (exitJS(_, !0), _);
        } catch (n) {
    ...
    function run(e = arguments_) {
      function t() {
        (Module.calledRun = !0, ABORT) || (initRuntime(), readyPromiseResolve?.(Module), Module.onRuntimeInitialized?.(), Module.noInitialRun || !1 || callMain(e), postRun());
      }
      runDependencies > 0 ? dependenciesFulfilled = run : (preRun(), runDependencies > 0 ? dependenciesFulfilled = run : (__name(t, "doRun"), Module.setStatus ? (Module.setStatus("Running..."), setTimeout(() => {
        (setTimeout(() => Module.setStatus(""), 1), t());
      }, 1)) : t()));
    }
    function preInit() {
      if (Module.preInit) for ("function" == typeof Module.preInit && (Module.preInit = [Module.preInit]); Module.preInit.length > 0; ) Module.preInit.shift()();
    }
    return (__name(callMain, "callMain"), __name(run, "run"), __name(preInit, "preInit"), preInit(), run(), moduleRtn = runtimeInitialized ? Module : new Promise((e, t) => {
      (readyPromiseResolve = e, readyPromiseReject = t);
    }), moduleRtn);
  }
  __name(Module2, "Module");
  var web_tree_sitter_default = Module2, Module3 = null, TRANSFER_BUFFER, LANGUAGE_VERSION, MIN_COMPATIBLE_VERSION;
  ...
  var Parser = class {
    ...
    setLanguage(e) {
      ...
      } else (t = 0, this.language = null);
      return (C._ts_parser_set_language(this[0], t), this);
    }
    parse(e, t, r) {
      if ("string" == typeof e) C.currentParseCallback = t => e.slice(t); else {
    ...
    setLogger(e) {
      if (e) {
        ...
        this.logCallback = e;
      } else this.logCallback = null;
      return this;
    }
    getLogger() {
      return this.logCallback;
    }
  }, PREDICATE_STEP_TYPE_CAPTURE = 1, PREDICATE_STEP_TYPE_STRING = 2, QUERY_WORD_REGEX = /[\w-]+/g, isCaptureStep = __name(e => "capture" === e.type, "isCaptureStep"), isStringStep = __name(e => "string" === e.type, "isStringStep"), QueryErrorKind = {
    Syntax: 1,
    NodeName: 2,
    FieldName: 3,
    CaptureName: 4,
  ...
  function parseMatchPredicate(e, t, r, s) {
    if (3 !== e.length) throw new Error(`Wrong number of arguments to \`#${r}\` predicate. Expected 2, got ${e.length - 1}.`);
  ...
  function parseSetDirective(e, t, r) {
    ...
    (r[t] || (r[t] = {}), r[t][e[1].value] = e[2]?.value ?? null);
  }
  function parsePattern(e, t, r, s, a, _, n, o, i, l, u) {
    if (t === PREDICATE_STEP_TYPE_CAPTURE) {
      ...
      switch (t) {
        ...
        case "any-eq?":
        case "eq?":
          parseAnyPredicate(_, e, t, n);
          break;
        case "any-not-match?":
        case "not-match?":
        case "any-match?":
        case "match?":
          parseMatchPredicate(_, e, t, n);
          break;
        case "not-any-of?":
        case "any-of?":
          parseAnyOfPredicate(_, e, t, n);
          break;
        case "is?":
        case "is-not?":
          parseIsPredicate(_, e, t, l, u);
          break;
        case "set!":
          parseSetDirective(_, e, i);
          break;
        default:
          o[e].push({
            operator: t,
  ...
  var Query = class {
    ...
    constructor(e, t) {
      ...
      (C._free(s), this[0] = a, this.captureNames = i, this.captureQuantifiers = l, this.textPredicates = g, this.predicates = h, this.setProperties = d, this.assertedProperties = m, this.refutedProperties = c, this.exceededMatchLimit = !1);
    }
    delete() {
    ...
    captures(e, t = {}) {
      ...
      return (C._free(u), C.currentQueryProgressCallback = null, m);
    }
    ...
    isPatternRooted(e) {
      return 1 === C._ts_query_is_pattern_rooted(this[0], e);
    }
    isPatternNonLocal(e) {
      return 1 === C._ts_query_is_pattern_non_local(this[0], e);
    }
